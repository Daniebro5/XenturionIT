...
struct ContentView: View {
    ...
    // propiedades booleanas tratemos de usar verbos de si y no
    // esta? es? usa? tiene?
    @FocusState private var estaElFocusEnValorTotal: Bool
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    .focused($estaElFocusEnValorTotal)
            ...
            .navigationTitle("Dividir la propina")
            .toolbar {
                if estaElFocusEnValorTotal {
                    Button("Listo") {
                        estaElFocusEnValorTotal = false
                    }
                }
            }
        }
...
// Focus en FrontEnd significa el objeto de UI que está respondiendo al usuario
